...
Module HFBTHO
  ...
  Real(pr) :: bet,beta0,q,bp,bpp,bz,hom,hb0,b0,etot,coex,cex,ty20,vin,rin,ain,  &
              ...
              bmm3,cmm3,chargee2,EBASECUT,rho_c,cdef,b2_0,b4_0,wct_gogny,hb0n,hb0p
  ...
  Real(pr), Allocatable :: ddfrag(:),ccsi(:)
  Real(pr) :: neckLag,neckValue,neckRequested,mixing_neck=0.5_pr
  Real(pr) :: dfragLag,dfragValue,dfragRequested,mixing_dfrag=0.5_pr
  Real(pr) :: csiLag,csiValue,csiRequested,mixing_csi=0.5_pr
  ! Temperature
  ...
  Logical :: dfrag_constraints = .False.
  Logical :: csi_constraints = .False.
  ...
  Logical      :: add_initial_pairing, set_temperature, compatibility_HFODD, force_parity, &
                  ...
                  localization_functions, set_neck_constrain, set_dfrag_constrain, set_csi_constrain
  ...
  Real(pr)     :: oscillator_length, basis_deformation, beta2_deformation, beta4_deformation, &
                  ...
                  neck_value, dfrag_value, csi_value
  ...
  Namelist /HFBTHO_DFRAG/ set_dfrag_constrain, dfrag_value
  Namelist /HFBTHO_CSI/ set_csi_constrain, csi_value
  ...
  Real(pr) :: beta_step, beta_deformation,separation_2N,Minimum_Energy,&
              Minimum_Energy_Prev,Energy_chain,Q20
  ...
  !---------------------------------------------------------------------
  Integer(ipr), Parameter :: n_func_param=12
  Real(pr), Dimension(1:n_func_param) :: functional_vector = 0._pr
End Module HFBTHO
