...
Contains
          ...
          Do ib = 1,nb
             ...
             If(n_qp.Gt.0) Then
                ...
                If(debug_inertia.Ge.2) Then
                   ...
                   lambda_test=2
                   Call moments_expectation(lambda_test,it,ib,qvala,rho,dd2)
                   If(ib.Eq.nb) Write(6,'("ib=",i2," lambda=",i2," qvala=",f14.7," dd2=",f14.7)') ib,lambda,qvala,dd2
                   lambdb_test=3
                   Call moments_expectation(lambdb_test,it,ib,qvalb,rho,dd1)
                ...
                Call qp_basis_F20(nd,n_qp,Umatr,Vmatr,FOPQPA)
                FOPQPB=zero; multMatElems=zero
                Call moments_computeField(lambdb,ib)
                Call qp_basis_F20(nd,n_qp,Umatr,Vmatr,FOPQPB)
                !
                aux=zero
                Do mu=1,n_qp
                   Do nu=1,n_qp
  ...
  !=======================================================================
  Subroutine qp_basis_F20(nd,n_qp,Umatr,Vmatr,FOPQP)
    Use HFBTHO_utilities
    Implicit None
